...
| P1 | Recycle only after high retained cgroup working set | Recover allocator-retained memory without reacting to reclaimable page cache | Raw warmed-container usage was ~1.42 GiB but working set only ~238 MiB | Low; guard already exists |
