...
| P2 | Add a production-safe `.dockerignore` | Keep local databases, environments, Git history, and profiler artifacts out of Docker build contexts | The first local image accidentally included a 612 MiB untracked SQLite database and invalidated its entrypoint cache baseline | Low |
