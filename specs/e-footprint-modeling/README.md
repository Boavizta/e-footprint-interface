...
may also be reported per benchmark operation and for the complete hosted service over one, two and three years.
...
No production usage evidence exists yet, so the model must show a range. These are provisional scenario anchors for the
first twelve months, stated in **active modeling sessions** rather than unique people:

| Case | Month-1 visits | Active-session conversion | Month-1 active sessions | Monthly growth | Approx. year-1 active sessions |
|---|---:|---:|---:|---:|---:|
| Low / quiet launch | 250 | 10% | 25 | 0% | 300 |
| Expected public adoption | 1,500 | 15% | 225 | 5% | 3,580 |
| High / niche breakout | 10,000 | 20% | 2,000 | 8% | 37,950 |

Apply the S1–S4 mix only to the active-session column. Model landing-only visits separately with their observed request
mix. For years two and three, show at least flat, continued-growth and plateau variants rather than extending one
exponential curve without limit.
