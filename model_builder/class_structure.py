...
from typing import get_origin, List, get_args, _empty as empty_annotation
    ...
    for attr_name in init_sig_params.keys():
        ...
        if get_origin(annotation) and get_origin(annotation) in (list, List):
            ...
            structure_fields.append({
                ...
                "options": model_web.get_web_objects_from_efootprint_type(list_attribute_object_type_str)
            })
            ...
            structure_fields.append({
                ...
                "id": id_prefix + "_" + attr_name,
                "name": attr_name,
                "default": str(default_values[attr_name].value)
            })
        elif issubclass(annotation, ExplainableQuantity):
            ...
            structure_fields.append({
                ...
                "default": default.rounded_magnitude
            })
        elif issubclass(annotation, ExplainableObject):
                ...
                dynamic_lists.append(
                    {
                        ...
                        "filter_by": id_prefix + "_" + conditional_list_values["depends_on"],
                        "list_value": {
                            str(conditional_value): [str(possible_value) for possible_value in possible_values]
            ...
            structure_fields.append({
                ...
                "id": id_prefix + "_" + attr_name,
                "name": attr_name,
                "selected": default_values[attr_name].id,
                "options": model_web.get_web_objects_from_efootprint_type(mod_obj_attribute_object_type_str)
            })
