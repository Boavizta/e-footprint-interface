...
DATA_PRIVACY_HOSTING_PROVIDER_NAME = os.getenv(
    "DATA_PRIVACY_HOSTING_PROVIDER_NAME", "Clever Cloud" if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else ""
)
DATA_PRIVACY_HOSTING_REGION = os.getenv(
    "DATA_PRIVACY_HOSTING_REGION", "Paris" if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else ""
)
DATA_PRIVACY_SECURITY_CONTACT = os.getenv(
    "DATA_PRIVACY_SECURITY_CONTACT",
    "vincent.villet@publicissapient.com" if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else "",
)
DATA_PRIVACY_HTTPS_ENABLED = optional_env_bool(
    "DATA_PRIVACY_HTTPS_ENABLED", True if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else None
)
DATA_PRIVACY_REDIS_TLS_SETUP_IN_PROGRESS = optional_env_bool(
    "DATA_PRIVACY_REDIS_TLS_SETUP_IN_PROGRESS", DATA_PRIVACY_PUBLIC_SHARED_INSTANCE
) is True
DATA_PRIVACY_REDIS_BACKUP_DISABLE_IN_PROGRESS = optional_env_bool(
    "DATA_PRIVACY_REDIS_BACKUP_DISABLE_IN_PROGRESS", DATA_PRIVACY_PUBLIC_SHARED_INSTANCE
) is True
DATA_PRIVACY_POSTGRES_ENCRYPTED_AT_REST = optional_env_bool(
    "DATA_PRIVACY_POSTGRES_ENCRYPTED_AT_REST", True if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else None
)
DATA_PRIVACY_POSTGRES_BACKUPS_ENABLED = optional_env_bool(
    "DATA_PRIVACY_POSTGRES_BACKUPS_ENABLED", True if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else None
)
DATA_PRIVACY_POSTGRES_BACKUP_FREQUENCY = os.getenv(
    "DATA_PRIVACY_POSTGRES_BACKUP_FREQUENCY", "daily" if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else ""
)
DATA_PRIVACY_POSTGRES_BACKUP_RETENTION_DAYS = int(
    os.getenv("DATA_PRIVACY_POSTGRES_BACKUP_RETENTION_DAYS", "7" if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else "0")
)
DATA_PRIVACY_POSTGRES_BACKUPS_ENCRYPTED_AT_REST = optional_env_bool(
    "DATA_PRIVACY_POSTGRES_BACKUPS_ENCRYPTED_AT_REST", False if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else None
)
DATA_PRIVACY_POSTGRES_BACKUP_ENCRYPTION_IN_PROGRESS = optional_env_bool(
    "DATA_PRIVACY_POSTGRES_BACKUP_ENCRYPTION_IN_PROGRESS", DATA_PRIVACY_PUBLIC_SHARED_INSTANCE
) is True
DATA_PRIVACY_POSTGRES_BACKUP_WINDOW = os.getenv(
    "DATA_PRIVACY_POSTGRES_BACKUP_WINDOW", "overnight" if DATA_PRIVACY_PUBLIC_SHARED_INSTANCE else ""
)
