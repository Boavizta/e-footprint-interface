...
### Changed
- The weekly-pattern editor now uses compact profile cards and day pills, with a full-size live preview fixed outside and immediately left of the side panel (inline on phones). Forms with several weekly fields show only the preview currently being edited.
