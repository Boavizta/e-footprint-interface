...
### Changed
- Derive Gunicorn's post-request worker recycling threshold from the container memory limit instead of a fixed 1.6 GB value, with ratio and absolute environment overrides.
