...
| **Standardized reporting export** — a GHG Protocol / ISO 14067 digital-service summary block (kg CO2-eq by phase, by object category) alongside JSON. | 1 | [ecoscan](2026-05-19-ecoscan.md) | parked | Reporting-segment need; weigh against the deprioritized reporting audience in comms strategy. |
